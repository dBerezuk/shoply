...
!(function (e, t) {
		...
		special: {
			...
			click: {
				setup: function (e) {
					var t = this || e;
					return (
						de.test(t.type) && t.click && A(t, 'input') && ke(t, 'click', Te),
						!1
					);
				},
				trigger: function (e) {
					var t = this || e;
					return (
						de.test(t.type) && t.click && A(t, 'input') && ke(t, 'click'), !0
					);
				},
				_default: function (e) {
					var t = e.target;
	...
	w.extend(w.event, {
		trigger: function (t, n, r, i) {
			...
			if (
				...
				if (!i && !p.noBubble && !g(r)) {
					for (
						u = p.delegateType || m, mt.test(u + m) || (a = a.parentNode);
						a;
						a = a.parentNode
					)
						y.push(a), (s = a);
	...
	w.ajaxSetup({
		...
		(d.createHTMLDocument =
			(((_t = v.implementation.createHTMLDocument('').body).innerHTML =
				'<form></form><form></form>'),
